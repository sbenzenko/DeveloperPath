...
/// </summary>
public record DeleteSource : IRequest<Source>
{
  /// <summary>
  /// Source Id
  /// </summary>
...
internal class DeleteSourceCommandHandler : IRequestHandler<DeleteSource, Source>
{
  ...
  public async Task<Source> Handle(DeleteSource request, CancellationToken cancellationToken)
  {
