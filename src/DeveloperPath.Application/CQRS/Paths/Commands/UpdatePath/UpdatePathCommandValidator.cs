...
public class UpdatePathCommandValidator : AbstractValidator<UpdatePath>
{
  ...
  public UpdatePathCommandValidator(IUniqueNamingValidation namingValidation)
  {
    ...
    RuleFor(v => v.Title)
      ...
      .MustAsync((path, title, cancellationToken) => _namingValidation.BeUniqueTitle(path.Id, title, cancellationToken))
    ...
    RuleFor(v => v.Key)
        ...
        .MustAsync((path, key, cancellationToken) => _namingValidation.BeUniqueKey(path.Id, key, cancellationToken))
