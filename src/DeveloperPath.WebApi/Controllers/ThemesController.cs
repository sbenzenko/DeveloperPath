...
public class ThemesController : ApiController
{
    ...
    [HttpGet]
    [HttpHead]
    public async Task<ActionResult<IEnumerable<Theme>>> Get(Guid pathId, Guid moduleId,
    ...
    public async Task<ActionResult<Theme>> Get(Guid pathId, Guid moduleId, Guid themeId,
        CancellationToken ct = default)
    {
