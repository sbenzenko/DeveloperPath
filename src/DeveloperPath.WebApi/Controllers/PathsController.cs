...
public class PathsController : ApiController
{
    ...
    {
        var parameters = new PathRequestParams(requestParams);
        var result = await _mediator.Send(new GetPathPagedListQuery()
        {
            PageSize = parameters.PageSize,
            PageNumber = parameters.PageNumber,
            OnlyVisible = parameters.OnlyVisible
        }, ct);
    ...
    {
        var parameters = new RequestParams(requestParams);
