...
using DeveloperPath.IdentityProvider.Attributes;

using IdentityModel;

using IdentityProvider.Models;
using IdentityProvider.Models.Account;
  ...
  public async Task<IActionResult> Login(LoginInputModel model, string button)
  {
    ...
    if (ModelState.IsValid)
    {
      ...
      else
      {
        ...
        {
          return RedirectToAction("RegisterConfirmation", "Register",
              new RegisterConfirmationModel { Login = model.Username, ReturnUrl = model.ReturnUrl });
        }
      }
