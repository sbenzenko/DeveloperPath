...
namespace IdentityProvider
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      // In development don't use email sender
      if (Environment.IsDevelopment())
        services.AddScoped<IServiceBusSenderService>(provider => new FakeServiceBusSenderService(Configuration["ServiceBusSenderConnectionString"]));
      else
